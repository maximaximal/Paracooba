...
./parac --worker 1 --distrac-enable --distrac-output ${N}_7.trace --id 7 $3 --known-remote localhost:18100 --auto-shutdown-time 3000 > ${N}_7.log 2>&1 &
./parac --worker 1 --distrac-enable --distrac-output ${N}_8.trace --id 8 $3 --known-remote localhost:18100 --auto-shutdown-time 3000 > ${N}_8.log 2>&1
