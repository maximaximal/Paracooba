...
CEREAL_REGISTER_TYPE(parac::solver_qbf::cubesource::PathDefined)
CEREAL_REGISTER_TYPE(parac::solver_qbf::cubesource::Supplied)
CEREAL_REGISTER_TYPE(parac::solver_qbf::cubesource::Unspecified)
CEREAL_REGISTER_TYPE(parac::solver_qbf::cubesource::CaDiCaLCubes)
CEREAL_REGISTER_POLYMORPHIC_RELATION(parac::solver_qbf::cubesource::Source,
                                     parac::solver_qbf::cubesource::PathDefined)
CEREAL_REGISTER_POLYMORPHIC_RELATION(parac::solver_qbf::cubesource::Source,
                                     parac::solver_qbf::cubesource::Supplied)
CEREAL_REGISTER_POLYMORPHIC_RELATION(parac::solver_qbf::cubesource::Source,
                                     parac::solver_qbf::cubesource::Unspecified)
CEREAL_REGISTER_POLYMORPHIC_RELATION(parac::solver_qbf::cubesource::Source,
                                     parac::solver_qbf::cubesource::CaDiCaLCubes)
